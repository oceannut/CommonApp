...
namespace ThinkInBio.Common.Utilities
{
    ...
    public static class ChineseToSpell
    {
        ...
        //Ô´ÂëÏÂÔØ:http://www.51aspx.com/CV/HanZiZhuanPinYin
         ...
         new string[][]
   {
    ...
    new string[]{"En","¶÷ÞôÝìàÅŠCWŸ¸ð†ßí"},//5_1_a_s_p_x.c_o_m
    new string[]{"Eng","íE"},
    new string[]{"Eo","˜"},
    new string[]{"Eol","s"},
    new string[]{"Eom","™ë"},////5_1_a_s_p_x.c_o_m
    new string[]{"Eos","”ñ"},
    ...
    new string[]{"Fo","·ð–¦ˆu—‚"},
    new string[]{"Fou","·ñó¾²»ˆ¡Švžä¼€ÀŒÀÆ]Ð[ë€ø]"},//5_1_a_s_p_x.c_o_m
    ...
    new string[]{"Gib","†Ö"},
    new string[]{"Go","†ñ"},//5_1_a_s_p_x.c_o_m
    ...
    new string[]{"Ho","Y"},//5_1_a_s_p_x.c_o_m
    new string[]{"Hol","b"},
    ...
    new string[]{"Kal","f"},//5_1_a_s_p_x.c_o_m
